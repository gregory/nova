...
export type AccountGetAccountInformationResponse =
  AccountGetAccountInformationResponses[keyof AccountGetAccountInformationResponses];
...
export type AccountGetSsoTokenResponse =
  AccountGetSsoTokenResponses[keyof AccountGetSsoTokenResponses];
...
export type AccountPostSequencesResponse =
  AccountPostSequencesResponses[keyof AccountPostSequencesResponses];
...
export type AccountRegisterCompanyResponse =
  AccountRegisterCompanyResponses[keyof AccountRegisterCompanyResponses];
...
export type AccountUpdateLicenseResponse =
  AccountUpdateLicenseResponses[keyof AccountUpdateLicenseResponses];
...
export type AccountAddLicenseBillableResponse =
  AccountAddLicenseBillableResponses[keyof AccountAddLicenseBillableResponses];
...
export type AccountantGetFeedsResponse =
  AccountantGetFeedsResponses[keyof AccountantGetFeedsResponses];
...
export type AccountantGetIndexResponse =
  AccountantGetIndexResponses[keyof AccountantGetIndexResponses];
...
export type AccountantGetFileResponse =
  AccountantGetFileResponses[keyof AccountantGetFileResponses];
...
export type CashbookInitializeCashbookResponse =
  CashbookInitializeCashbookResponses[keyof CashbookInitializeCashbookResponses];
...
export type CashbookGetCashbookResponse =
  CashbookGetCashbookResponses[keyof CashbookGetCashbookResponses];
...
export type CashbookGetCashbookEntriesResponse =
  CashbookGetCashbookEntriesResponses[keyof CashbookGetCashbookEntriesResponses];
...
export type CashbookGetCashbooksResponse =
  CashbookGetCashbooksResponses[keyof CashbookGetCashbooksResponses];
...
export type CashbookGetCashbookHistoryResponse =
  CashbookGetCashbookHistoryResponses[keyof CashbookGetCashbookHistoryResponses];
...
export type CashbookPostCashbookEntryResponse =
  CashbookPostCashbookEntryResponses[keyof CashbookPostCashbookEntryResponses];
...
export type DailyReceiptPostDailyReceiptBookEntryResponse =
  DailyReceiptPostDailyReceiptBookEntryResponses[keyof DailyReceiptPostDailyReceiptBookEntryResponses];
...
export type DailyReceiptGetDailyReceiptEntryResponse =
  DailyReceiptGetDailyReceiptEntryResponses[keyof DailyReceiptGetDailyReceiptEntryResponses];
...
export type DailyReceiptGetDailyReceiptBooksResponse =
  DailyReceiptGetDailyReceiptBooksResponses[keyof DailyReceiptGetDailyReceiptBooksResponses];
...
export type DailyReceiptGetDailyReceiptBooks2Response =
  DailyReceiptGetDailyReceiptBooks2Responses[keyof DailyReceiptGetDailyReceiptBooks2Responses];
...
export type DocumentGetDocumentsResponse =
  DocumentGetDocumentsResponses[keyof DocumentGetDocumentsResponses];
...
export type DocumentPostDocumentResponse =
  DocumentPostDocumentResponses[keyof DocumentPostDocumentResponses];
...
export type DocumentGetDocumentResponse =
  DocumentGetDocumentResponses[keyof DocumentGetDocumentResponses];
...
export type EinvoiceGetRegistrationsResponse =
  EinvoiceGetRegistrationsResponses[keyof EinvoiceGetRegistrationsResponses];
...
export type EinvoicePostRegistrationResponse =
  EinvoicePostRegistrationResponses[keyof EinvoicePostRegistrationResponses];
...
export type EinvoiceDeleteRegistrationResponse =
  EinvoiceDeleteRegistrationResponses[keyof EinvoiceDeleteRegistrationResponses];
...
export type EinvoiceGetRegistrationResponse =
  EinvoiceGetRegistrationResponses[keyof EinvoiceGetRegistrationResponses];
...
export type EinvoicePatchEntityResponse =
  EinvoicePatchEntityResponses[keyof EinvoicePatchEntityResponses];
...
export type EinvoicePostRegistrationIntegrationResponse =
  EinvoicePostRegistrationIntegrationResponses[keyof EinvoicePostRegistrationIntegrationResponses];
...
export type EinvoiceDeleteRegistrationIntegrationResponse =
  EinvoiceDeleteRegistrationIntegrationResponses[keyof EinvoiceDeleteRegistrationIntegrationResponses];
...
export type EinvoiceGetOrdersResponse =
  EinvoiceGetOrdersResponses[keyof EinvoiceGetOrdersResponses];
...
export type EinvoiceGetWebhooksResponse =
  EinvoiceGetWebhooksResponses[keyof EinvoiceGetWebhooksResponses];
...
export type EinvoicePostWebhookResponse =
  EinvoicePostWebhookResponses[keyof EinvoicePostWebhookResponses];
...
export type EinvoiceDeleteWebhooksResponse =
  EinvoiceDeleteWebhooksResponses[keyof EinvoiceDeleteWebhooksResponses];
...
export type EinvoiceRefreshWebhookSecretResponse =
  EinvoiceRefreshWebhookSecretResponses[keyof EinvoiceRefreshWebhookSecretResponses];
...
export type EinvoicePostKycInitiationResponse =
  EinvoicePostKycInitiationResponses[keyof EinvoicePostKycInitiationResponses];
...
export type GlAccountPostGlAccountResponse =
  GlAccountPostGlAccountResponses[keyof GlAccountPostGlAccountResponses];
...
export type MiscGetCompanySearchResponse =
  MiscGetCompanySearchResponses[keyof MiscGetCompanySearchResponses];
...
export type MiscGetTranslationResponse =
  MiscGetTranslationResponses[keyof MiscGetTranslationResponses];
...
export type OAuth2PostTokenRevokeResponse =
  OAuth2PostTokenRevokeResponses[keyof OAuth2PostTokenRevokeResponses];
...
export type PeppolPostSendOrderResponse =
  PeppolPostSendOrderResponses[keyof PeppolPostSendOrderResponses];
...
export type PeppolGetParticipantInformationResponse =
  PeppolGetParticipantInformationResponses[keyof PeppolGetParticipantInformationResponses];
...
export type ProductGetProductResponse =
  ProductGetProductResponses[keyof ProductGetProductResponses];
...
export type ProductPostProductResponse =
  ProductPostProductResponses[keyof ProductPostProductResponses];
...
export type ReportReportListGetResponse =
  ReportReportListGetResponses[keyof ReportReportListGetResponses];
...
export type ReportReportDetailGetResponse =
  ReportReportDetailGetResponses[keyof ReportReportDetailGetResponses];
...
export type ToProcessPostToProcessResponse =
  ToProcessPostToProcessResponses[keyof ToProcessPostToProcessResponses];
...
export type WebhookGetWebhooksResponse =
  WebhookGetWebhooksResponses[keyof WebhookGetWebhooksResponses];
...
export type WebhookPostWebhookResponse =
  WebhookPostWebhookResponses[keyof WebhookPostWebhookResponses];
...
export type WebhookDeleteWebhooksResponse =
  WebhookDeleteWebhooksResponses[keyof WebhookDeleteWebhooksResponses];
...
export type WebhookRefreshWebhookSecretResponse =
  WebhookRefreshWebhookSecretResponses[keyof WebhookRefreshWebhookSecretResponses];
